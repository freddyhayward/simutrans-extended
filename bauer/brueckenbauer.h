...
public:
	 ...
	 */
	static void build_ramp(player_t *player, koord3d end, ribi_t::ribi ribi_neu, old_slope_t::type weg_hang, const bridge_desc_t *desc, const way_desc_t *way_desc, overtaking_mode_t overtaking_mode, bool beginning);
